      ...
      return Column(
        ...
        children: [
          ...
          InkWell(
            ...
            child: RichText(
              text: TextSpan(
                  text: (value.followingCountt==null)? '${userData.followingCount} ' : '${value.followingCountt} ',
                  style: AppFonts.headerStyle(
                    context: context,
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: (value.followerCount==null)? "${userData.followerCount} " : "${value.followerCount} "),
                    TextSpan(
                      text: "Followers",
                      style: AppFonts.headerStyle(
